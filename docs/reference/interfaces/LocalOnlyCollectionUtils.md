...
Defined in: [packages/db/src/local-only.ts:41](https://github.com/TanStack/db/blob/main/packages/db/src/local-only.ts#L41)
...
Defined in: [packages/db/src/local-only.ts:59](https://github.com/TanStack/db/blob/main/packages/db/src/local-only.ts#L59)
